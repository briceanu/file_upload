...
SECRET_KEY = 'django-insecure-972qxhiiep783k6-7zt1kd1i!q-z#c()v2z==lal_v%oi(x7^#'
...
# under BASE_DIR creates a media directory where the curriculum vite will the saved
